classdef segmentedIVIMFit2compPlugin   
    properties
        app     % pointer to the TURQUOISE app.
    end

    methods (Access = public)
        function obj = segmentedIVIMFit2compPlugin(app)    
        ...
        function Excecute(obj) %runs when the plugin is selected from the menu
            ...
            for i = 1:length(targets)
                ...
                MRTQuant.PerformSegmentedIVIMFit2comp( ...
                    'nii_file', targetFn, ...
                    'bval_file', bvalFn, ...
                    'bvec_file', bvecFn, ...
                    'mask_file', maskFn, ...
                    'min_bval', min(bvals), ...
                    'max_bval', max(bvals), ...
                    'output', fullfile(obj.app.sessionPath, [targetName '_IVIM2comp']))
            end
