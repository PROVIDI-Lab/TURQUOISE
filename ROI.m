    ...
    methods (Static)
        ...
        %the points is filled in.
            ...
            for i = 1:length(slices)
                ...
                %the maskslice needs to be flipped / transposed sometimes.
                %A better overview of this is given in the 
                % MathUtils.ApplyProjection() function
                if (viewDim == 3 && imageOr == 3) ||...
                   (viewDim == 3 && imageOr == 1) ||...
                   (viewDim == 2 && imageOr == 1) ||...
                   (viewDim == 1 && imageOr == 2) ||...
                   (viewDim == 2 && imageOr == 2)
                ...
                % elseif 
                %     maskSlc         = flip(roipoly(maskSlc, xi, yi),2);
                else
                    maskSlc         = flip(roipoly(maskSlc, yi, xi),2);
                end
