...
%             x = hit.Source.Parent.Parent.Parent.CurrentPoint(1);
%             y = hit.Source.Parent.Parent.Parent.CurrentPoint(2);
            %TODO: do I even use x & y anywhere?
        ...
        function idx    = DistanceToPoints(points, x,y)
            ...
            [M, I]  = min(d);
            if M <= 10 %less than 5 voxels away
               idx  = I;
            end
        end
        ...
        function mask = PointsToMask(app, points, imID)
