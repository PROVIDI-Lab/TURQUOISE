...
%             app.view_axis               = 3;
        ...
        %Manages the scrollwheelEvent 
            ...
            slice   = app.slicePerImage(imID) - verticalScrollCount;
        ...
        function SliceUp(app)
            ...
            slice   = app.slicePerImage(imID) + 1;
...
%         end
        ...
        function UOContextMenu(app, id, hit)
            %Creates a contextmenu where the user clicked
            
            return
            cm = uicontextmenu(hit.Source.Parent.Parent.Parent);
            m1 = uimenu(cm,'Text','Delete');
            m2 = uimenu(cm,'Text','Rename');
            m3 = uimenu(cm,'Text','Copy To');
            m4 = uimenu(cm,'Text','Toggle Visibility');
            m5 = uimenu(cm,'Text','Toggle Info Box');
            hit.Source.Parent.Parent.Parent.ContextMenu = cm;
            open(cm, hit.IntersectionPoint(1), hit.IntersectionPoint(2))
